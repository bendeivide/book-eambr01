...
```{r InstalacaoR01, echo=FALSE, out.width="100%", fig.cap=" Primeiro passo para Instalação do R",fig.align='center'}
knitr::include_graphics("img/Instalacao_R_01.PNG")
```

<!-- IMAGEM 02 -->
```{r InstalacaoR02, echo=FALSE, out.width="100%", fig.cap="Segundo passo para Instalação do R",fig.align='center'}
