...
```{r ModeloEstruturalBD, echo=FALSE, out.width="100%", fig.cap="Modelo estrutural de um banco de dados.",fig.align='center'}
knitr::include_graphics("img/Modelo_Estrutural_BD.PNG")
```
