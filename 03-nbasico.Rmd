...
```{r CriadorS, echo=FALSE, out.width="50%", fig.cap="John Chambers, o criador da linguagem S",fig.align='center'}
...
```{r CompletarFuncaoR, echo=FALSE, out.width="50%", fig.cap="Completando função sqrt utilizando a tecla TAB no Console R.",fig.align='center'}
knitr::include_graphics("img/Completar_Funcao_Console_R.png")
```
...
```{r CompletarFuncaoRStudio, echo=FALSE, out.width="50%", fig.cap="Completando função sqrt utilizando a tecla TAB no RStudio",fig.align='center'}
knitr::include_graphics("img/Completar_Funcao_RStudio.png")
```
...
```{r FuncaoArgumento, echo=FALSE, out.width="50%", fig.cap="Janela informando todos os argumentos possíveis da função sqrt.",fig.align='center'}
knitr::include_graphics("img/Funcao_Argumento.PNG")
```
...
```{r ExecutandoScriptConsoleR, echo=FALSE, out.width="100%", fig.cap="Janelas Console e Script lado a lado, o Script foi executado apertando F5.",fig.align='center'}
knitr::include_graphics("img/Executando_Script_ConsoleR.PNG")
```
...
```{r ExecutandoScriptConsoleRStudio, echo=FALSE, out.width="100%", fig.cap="Os quatro quadrantes do RStudio. O Script fica no primeiro quadrante, o mesmo foi executado apertando CTRL + ENTER do teclado.",fig.align='center'}
knitr::include_graphics("img/Executando_Script_ConsoleRStudio.PNG")
```
...
```{r ComentarioCodigoRStudio, echo=FALSE, out.width="100%", fig.cap="Comentários feitos para identificar o objetivo de cada função no Script.",fig.align='center'}
knitr::include_graphics("img/ComentarioCodigoRStudio.PNG")
```
