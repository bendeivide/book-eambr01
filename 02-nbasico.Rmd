...
<!-- IMAGEM 01   -->
```{r, echo=FALSE, out.width="100%", fig.cap=" Primeiro passo para Instalação do R",fig.align='center'}
knitr::include_graphics("img/Instalacao_R_01.PNG")
```

<!-- IMAGEM 02   -->
```{r, echo=FALSE, out.width="100%", fig.cap="Segundo passo para Instalação do R",fig.align='center'}
knitr::include_graphics("img/Instalacao_R_02.PNG")
```

<!-- IMAGEM 03   -->

```{r, echo=FALSE, out.width="100%", fig.cap="Terceiro passo para Instalação do R.",fig.align='center'}
knitr::include_graphics("img/Instalacao_R_03.PNG")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="Instalação do RStudio",fig.align='center'}
knitr::include_graphics("img/Instalacao_R_Studio01.PNG")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="Console do R (Versão 4.0.3)",fig.align='center'}
knitr::include_graphics("img/Console_do_R_01.PNG")
```
...
```{r CriadoresR, echo=FALSE, out.width="100%", fig.cap="Criadores do R. (Versão 1.4.1103)", fig.align='center'}
knitr::include_graphics("img/Criadores_R.PNG")
```
...
```{r CriadorRStudio, echo=FALSE, out.width="100%", fig.cap="J. J. Allaire, o criador do RStudio",fig.align='center'}
knitr::include_graphics("img/Criador_RStudio.PNG")
```
...
```{r RDay, echo=FALSE, out.width="100%", fig.cap="Foto de divulgação de Paulo Justiniano no R Day.",fig.align='center'}
knitr::include_graphics("img/RDay.PNG")
```
