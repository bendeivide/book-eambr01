...
```{r, echo=FALSE, out.width="100%", fig.cap="Inserção de comandos no Console R",fig.align='center'}
knitr::include_graphics("img/Console_do_R_Comando.PNG")
```
...
```{r CriadoresR, echo=FALSE, out.width="100%", fig.cap="Criadores do R.", fig.align='center'}
